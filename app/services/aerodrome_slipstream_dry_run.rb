...
class AerodromeSlipstreamDryRun
  ...
  def report_token(token_id)
    ...
    hedge_preview = AerodromeHedgePreview.new.preview(data)
    {
      ...
      hedge_preview_supported: hedge_preview.supported,
      hedge_preview_reason: hedge_preview.reason,
      hedge_asset: hedge_preview.hedge_asset,
      hedge_side: hedge_preview.hedge_side,
      suggested_short_amount: decimal_display(hedge_preview.suggested_short_amount),
      suggested_short_notional_usd: decimal_display(hedge_preview.suggested_short_notional_usd),
      lp_weth_amount: decimal_display(hedge_preview.lp_weth_amount),
      lp_usdc_amount: decimal_display(hedge_preview.lp_usdc_amount),
      lp_total_value_usd: decimal_display(hedge_preview.lp_total_value_usd),
      weth_price_usd: decimal_display(hedge_preview.weth_price_usd),
      hedge_preview_source: hedge_preview.source,
      hedge_preview_verification_status: hedge_preview.verification_status,
      execution_enabled: hedge_preview.execution_enabled,
      hyperliquid_called: hedge_preview.hyperliquid_called,
      hedge_enabled: false,
      database_write: false,
      error_class: nil,
      error_message: nil
  ...
  def error_report(token_id, error)
    {
      ...
      hedge_preview_verification_status: "error",
