...
ActiveRecord::Schema[8.1].define(version: 2026_06_03_000100) do
  ...
  create_table "position_hedge_accounting_snapshots", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "venue"
    t.index ["position_id"], name: "index_position_hedge_accounting_snapshots_on_position_id", unique: true
  end

  create_table "position_rewards_fees_snapshots", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.text "warnings"
    t.index ["position_id"], name: "index_position_rewards_fees_snapshots_on_position_id", unique: true
  end
  ...
  add_foreign_key "position_rewards_fees_snapshots", "positions"
